...
/* WEBPACK VAR INJECTION */(function($) {$('.logout').on('click', function () {
    alert('asldfjsdf');
    $('#logout').submit();
});
...
$(function () {
    ...
    $('.novo').on('click', function () {
        $('.form').find("input,textarea,select").val('').end().find("input[type=checkbox], input[type=radio]").prop("checked", "").end();
    });
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
